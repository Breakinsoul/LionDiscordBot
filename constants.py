...
gem_api_entry = 'https://www.poewiki.net/api.php?action=cargoquery&tables=items&fields=name,class&group_by=name&format=json&where=(class="Skill Gem" OR class="Support Gem") AND name LIKE '
